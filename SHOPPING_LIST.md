...
## 4. Raspberry Pi & Electronics (Amazon) - Base Build

| Qty | Item | Unit Price | Total | Link |
|-----|------|------------|-------|------|
| ~~1~~ | ~~Raspberry Pi 3 Model B (or 4)~~ | - | - | *OWNED* |
...
## 5. Power System (Amazon)

| Qty | Item | Unit Price | Total | Link |
|-----|------|------------|-------|------|
| ~~1~~ | ~~2S LiPo Battery 5200mAh~~ | - | - | *OWNED* |
| ~~1~~ | ~~Deans T-Plug Connectors~~ | - | - | *OWNED* |
| 1 | Inline Fuse Holder + 5A Fuses | $10 | $10 | [Amazon](https://amzn.to/3cCqfXf) |
| ~~1~~ | ~~LiPo Battery Charger~~ | - | - | *OWNED* |
| 1 | Power Switch (SPST) | $6 | $6 | [Amazon](https://amzn.to/2ApRB4L) |
...
## 7. Shafts & Bearings (McMaster-Carr / Amazon)
...
## 8. Hardware (Amazon / McMaster-Carr)
...
## 9. 3D Printing Filament

| Qty | Item | Unit Price | Total |
|-----|------|------------|-------|
| 3 | PLA/PETG 1kg spools | $25 | $75 |

**Note:** ~3kg total needed for all parts
...
### Amazon - Base Build (~$220)
- [ ] 2x LX-16A Bundle (10 servos + BusLinker) - $150
- [x] ~~Raspberry Pi 3/4~~ - *OWNED*
